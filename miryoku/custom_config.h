...
&kp LGUI,          &mkp LA(RCLK),     &mkp LA(MCLK),     &mkp LA(LCLK),     U_NA,              U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
...
&kp LGUI,          &mkp LC(RCLK),     &mkp LC(MCLK),     &mkp LC(LCLK),     U_NA,              U_NU,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            \
