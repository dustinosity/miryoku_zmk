...
&kp LGUI,          &kp LA(RCLK),      &kp LA(MCLK),      &kp LA(LCLK),      U_NA,              U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
...
&kp LGUI,          &kp LC(RCLK),      &kp LC(MCLK),      &kp LC(LCLK),      U_NA,              U_NU,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            \
